...
class AuthenticationUtils
{
    ...
    public function getLastID()
    {
        ...
        if ($request->attributes->has(Security::LAST_ID)) {
            return $request->attributes->get(Security::LAST_ID, '');
        }

        return $request->hasSession() ? $request->getSession()->get(Security::LAST_ID, '') : '';
    }
