...
class __TwigTemplate_f92479375165dd6a0e754106fa5e88177042520309cb25386f87357b9cf767de extends Template
{
    ...
    public function block_central($context, array $blocks = [])
    {
        ...
        // line 6
        echo "<div class='col-4'style='margin-left:35%; margin-top:2%; box-shadow : 0 0.5em 5em -0.125em #00947e, 0 0px 0 1px #00947e; border-radius:12px;padding:4%  '>
<form method=\"post\">
    ";
        // line 8
    ...
    <label for=\"inputPassword\"style=\"margin-top:2%\">Password</label>
    ...
    ";
        // line 39
        echo "
    <button class=\"btn btn-lg btn-primary\" style=\"margin-top:2%\" type=\"submit\">
        Sign in
    </button>
</form>
...
";
    ...
    {
        return array (  136 => 39,  130 => 26,  122 => 21,  116 => 17,  108 => 14,  105 => 13,  103 => 12,  100 => 11,  94 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block central %}
<div class='col-4'style='margin-left:35%; margin-top:2%; box-shadow : 0 0.5em 5em -0.125em #00947e, 0 0px 0 1px #00947e; border-radius:12px;padding:4%  '>
<form method=\"post\">
    {% if error %}
...
{% endblock %}
", "security/login.html.twig", "C:\\wamp64\\www\\symfony\\templates\\security\\login.html.twig");
    }
}
