 ...
 */
class getWishRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WishRepository' shared autowired service.
     *
     * @return \App\Repository\WishRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WishRepository.php';

        return $container->privates['App\\Repository\\WishRepository'] = new \App\Repository\WishRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
